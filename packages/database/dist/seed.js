...
async function main() {
    ...
    // Create collections
    const minimalCollection = await client_1.prisma.collection.upsert({
        where: { slug: 'minimal' },
        update: {},
        create: {
            name: 'Minimal',
    ...
    const abstractCollection = await client_1.prisma.collection.upsert({
        where: { slug: 'abstract' },
        update: {},
        create: {
            name: 'Abstract',
    ...
    const sampleProduct = await client_1.prisma.product.upsert({
    ...
    const smallVariant = await client_1.prisma.productVariant.upsert({
    ...
    const mediumVariant = await client_1.prisma.productVariant.upsert({
    ...
    const podcastStudio = await client_1.prisma.studioSpace.upsert({
